# EXP-5854C2 — Aureline Labs Research Report

**Date:** 2026-06-28
**Strategy:** ML_RandomForest
**Asset:** XOM
**Period:** 2021-01-01 → 2026-06-01
**Tags:** `ml`, `cross-ticker-validation`, `full_27`, `xom`

---

## Hypothesis

> Does the full_27 feature set show predictive edge on XOM over the test period 2024-2026?
...
ROC-AUC 0.5061 on XOM using 27 features. Top feature: mom_return_1d.
