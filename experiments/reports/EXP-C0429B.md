# EXP-C0429B — Aureline Labs Research Report

**Date:** 2026-06-28
**Strategy:** ML_RandomForest
**Asset:** AAPL
**Period:** 2021-01-01 → 2026-06-01
**Tags:** `ml`, `cross-ticker-validation`, `full_27`, `aapl`

---

## Hypothesis

> Does the full_27 feature set show predictive edge on AAPL over the test period 2024-2026?
...
ROC-AUC 0.4782 on AAPL using 27 features. Top feature: trend_dist_sma50.
