# EXP-224BB2 — Aureline Labs Research Report

**Date:** 2026-06-28
**Strategy:** ML_RandomForest
**Asset:** NVDA
**Period:** 2021-01-01 → 2026-06-01
**Tags:** `ml`, `cross-ticker-validation`, `full_27`, `nvda`

---

## Hypothesis

> Does the full_27 feature set show predictive edge on NVDA over the test period 2024-2026?
...
ROC-AUC 0.4930 on NVDA using 27 features. Top feature: mom_return_1d.
